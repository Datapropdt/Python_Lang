...
#public variables are defined in the class and can
#be accessed from anywhere in
# the program using . (dot) operator. from with in
#the class as well as from
# outside the class.
...
print("from class method , var2 = ",obj.var2) # var2 is a private variable cant access
                                                # outside the class, to access
                                                # it use object
